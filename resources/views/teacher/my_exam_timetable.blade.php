                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            <a href="{{ url('teacher/dashboard') }}" class="btn btn-primary btn-round">Revenir sur le
                                dashboard</a>
                        </div>
                    </div>
                        ...
                        <div class="card my-4 p-4">
                            <div class="card-header d-flex justify-content-between align-items-center"
                                ...
                                <span class="px-3 py-1 rounded"
                                    ...
                                    <b> Classe : {{ $value['class_name'] }}</b>
                                </span>
                            </div>

                            <div class="card-body">
                                @foreach ($value['exam'] as $exam)
                                    <!-- Badge de l'examen avec espace plus grand -->
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        <span class="px-3 py-2 rounded"
                                            style="background-color:#007bff; color:#fff; font-size:14px;">
                                            <b>Type d'examen : {{ $exam['exam_name'] }}</b>
                                        </span>
                                    </div>

                                    <!-- Tableau des matières avec marge plus importante -->
                                    ...
                                    <!-- Trait horizontal pour séparer les examens -->
                                    <hr class="my-4">
                                @endforeach
                            </div>
                        </div>
