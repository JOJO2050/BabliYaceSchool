                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('teacher/dashboard') }}" class="btn btn-primary btn-round">Retour sur le
                                dashboard</a>
                        </div>
                    </div>
                    @include('_message')
                    <div class="card my-4 p-4">
                        <div class="card-header" style="font-size: 20px;"><b>Formulaire d'édition des données de :
                                {{ Auth::user()->name }} {{ Auth::user()->last_name }}</b>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="setting-input-3"
                                                name="marital_status"
                                                value="{{ old('marital_satus', $getRecord->marital_status) }}"
