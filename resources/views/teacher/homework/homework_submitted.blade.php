                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            <a href="{{ url('teacher/homework/homework_list') }}" class="btn btn-primary btn-round">
                                Retour sur la liste des devoirs
                            </a>
                        </div>
                    </div>
                    @include('_message')
                    <div class="card my-4 p-2">
                        ...
                        <div class="card my-4 p-2">
                            <div class="app-card app-card-settings shadow-sm p-4" style="background-color:#d8e0de;">
                                <div class="card-body">
                                    <form method="GET"
                                        action="{{ url('teacher/homework/homework_submitted/' . $homework_id) }}">
                                        <div class="row align-items-end">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <label for="first_name" class="form-label"><b>Nom</b></label>
                                                <input type="text" name="first_name" id="first_name"
                                                    class="form-control" value="{{ Request::get('first_name') }}"
                                                    placeholder=" Nom">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="last_name" class="form-label"><b>Prénom</b></label>
                                        ...
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                <div class="d-flex justify-content-end gap-2">
                                                    ...
                                                    <a href="{{ url('teacher/homework/homework_submitted/' . $homework_id) }}"
                                                ...
                                                <tr>
                                                    <td colspan="7" class="text-center py-4">
                                                        <div class="text-muted">
                                                            ...
                                                            <p class="mb-0">Aucun élève n'a encore envoyé ce devoir.
                                                            </p>
                                                        </div>
                                                    </td>
                                                </tr>
