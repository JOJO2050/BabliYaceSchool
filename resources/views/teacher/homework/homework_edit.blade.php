                ...
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="mt-4 app-page-title d-inline-block px-3 py-1 rounded"
                                style="background-color:#28a745;color:#fff;">Espace Professeur</h3>
                        </div>
                    ...
                    <div class="card my-4 p-4">
                        ...
                        <div class="card-header" style="font-size:20px;">
                            <b>Formulaire de modification du devoir</b>
                        </div>
                        ...
                        <div class="app-card app-card-settings shadow-sm p-4">
                            ...
                            <div class="card-body">
                                ...
                                <form class="settings-form" method="POST"
                                    action="{{ url('teacher/homework/homework_update/' . $getRecord->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 mb-4">
                                            <label for="getClass" class="form-label">
                                                <b>Classe <span style="color: red">*</span></b>
                                            </label>

                                            <select name="class_id" id="getClass" class="form-select" required>
                                                <option value="">~~Sélectionner une classe~~</option>

                                                @foreach ($getClass as $class)
                                                    <option value="{{ $class->class_id }}"
                                                        {{ old('class_id', $getRecord->class_id) == $class->class_id ? 'selected' : '' }}>
                                                        {{ $class->class_name }}
                                                    </option>
                                                @endforeach
                                        ...
                                        <div class="col-md-2 mb-4">
                                            <label for="getSubject" class="form-label">
                                                <b>Matière <span style="color: red">*</span></b>
                                            </label>

                                            <select name="subject_id" id="getSubject" class="form-select" required>
                                                <option value="">Sélectionner une matière</option>

                                                @foreach ($getSubject as $subject)
                                                    <option value="{{ $subject->subject_id }}"
                                                        {{ old('subject_id', $getRecord->subject_id) == $subject->subject_id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-2 mb-4">
                                            <label><b>Date d'emission du devoir</b><span
                                        ...
                                        <div class="col-md-3 mb-4">
                                            <label><b>Date de rendu du devoir</b><span
                                                    style="color: red">*</span></label>
                                        ...
                                        <div class="col-md-3 mb-4">
                                            ...
                                            @if (!empty($getRecord->document_file))
                                                <div class="mt-2">
                                                    <a href="{{ $getRecord->getDocument() }}" target="_blank"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="description" id="compose-textarea" class="form-control" rows="15" required>{{ old('description', $getRecord->description) }}</textarea>
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <b><i class="fas fa-sync-alt"></i> Mettre à jour</b>
                                    </button>
        ...
        $(document).ready(function() {
            ...
            $("#getClass").change(function() {
                ...
                if (class_id === "") {
                    ...
                    $("#getSubject")
                        .html('<option value="">Sélectionner une classe d\'abord</option>')
                        .prop("disabled", true);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.success === false) {
                            ...
                            $("#getSubject").val(
                                "{{ old('subject_id', $getRecord->subject_id) }}");
