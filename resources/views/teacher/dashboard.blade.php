...
<head>
    ...
    <title>BabliYaceSchoolDashboard</title>
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src={{ asset('assets1/img/flags/id.png') }}
                                                                        alt="indonesia" />
                                                                </div>
                                                            </td>
                                                            <td>Indonesia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src={{ asset('assets1/img/flags/us.png') }}
                                                                        alt="united states" />
                                                                </div>
                                                            </td>
                                                            <td>USA</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src={{ asset('assets1/img/flags/au.png') }}
                                                                        alt="australia" />
                                                                </div>
                                                            </td>
                                                            <td>Australia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src={{ asset('assets1/img/flags/ru.png') }}
                                                                        alt="russia" />
                                                                </div>
                                                            </td>
                                                            <td>Russia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src={{ asset('assets1/img/flags/cn.png') }}
                                                                        alt="china" />
                                                                </div>
                                                            </td>
                                                            <td>China</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src={{ asset('assets1/img/flags/br.png') }}
                                                                        alt="brazil" />
                                                                </div>
                                                            </td>
                                                            <td>Brasil</td>
                            ...
                            <div class="card card-round">
                                <div class="card-body">
                                    ...
                                    <div class="card-list py-4">
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src={{ asset('assets1/img/jm_denis.jpg') }} alt="..."
                                        ...
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src={{ asset('assets1/img/talha.jpg') }} alt="..."
                                                    class="avatar-img rounded-circle" />
                                            </div>
                                            <div class="info-user ms-3">
                                        ...
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src={{ asset('assets1/img/chadengle.jpg') }} alt="..."
                                                    class="avatar-img rounded-circle" />
                                            </div>
                                            <div class="info-user ms-3">
