                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('admin/admin/list') }}" class="btn btn-primary btn-round">liste des
                                Administrateurs</a>
                        </div>
                    </div>
                    @include('_message')
                    <div class="card my-4 p-4">
                        <div class="card-header" style="font-size: 20px;"><b>Formulaire de Modification des
                                administrateurs</b>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="setting-input-1"
                                                name="name" value="{{ $getRecord->name }}" required
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="email" class="form-control" id="setting-input-3"
                                                name="email" value="{{ $getRecord->email }}" required
