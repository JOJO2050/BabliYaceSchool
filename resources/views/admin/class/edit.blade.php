                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('admin/class/list') }}" class="btn btn-primary btn-round">Voir Liste des
                                Classes</a>
                        </div>
                    </div>
                    @include('_message')
                    <div class="card my-4 p-4">
                        <div class="card-header" style="font-size: 20px;"><b>Formulaire d'édition des classes</b>
                        </div>
                        <div class="app-card app-card-settings shadow-sm p-4">
                            <div class="card-body">
                                <form class="settings-form" method="POST" action="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="setting-input-1"
                                                name="name" placeholder="Entrez le Nom de votre Classe"
                                    ...
                                    <button type="submit" class="btn btn-primary"><b>Mettre à jours</b></button>
                                </form>
                            </div>
                        </div>
