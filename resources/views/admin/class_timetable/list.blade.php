                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('admin/dashboard') }}" class="btn btn-primary btn-round">Revenir sur
                                le dashboard
                            </a>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 mb-3">
                                            ...
                                            <select class="form-control getClass" name="class_id" required
                                                ...
                                                <option value="">~~~~~~~~~~~~~~~~~~~~~~~~~~~~Veillez choisir une
                                                    classe~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                                                </option>
                                        ...
                                        <div class="col-md-2 mb-3"><button type="submit" class="btn btn-primary"
                                            ...
                                            <a href="{{ url('admin/class_timetable/list') }}" class="btn btn-danger"
                    ...
                    @if (!empty(Request::get('class_id')) && !empty(Request::get('subject_id')))
                        <form class="settings-form" method="post" action="{{ url('admin/class_timetable/add') }}">
                            {{ csrf_field() }}
