                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('admin/examination/exam/list') }}" class="btn btn-primary btn-round">Voir
                                Liste des
                                des examens</a>
                        </div>
                    </div>
                    ...
                    <div class="card my-4 p-4">
                        <div class="card-header" style="font-size: 20px;"><b>Formulaire d'ajout des examens</b>
                        </div>
                                ...
                                <form class="settings-form" method="POST" action="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control" id="setting-input-3" name="description" placeholder="Entrez une description"></textarea>
                                            @error('description')
                                                <div class="text-danger"><b>{{ $message }}</b></div>
                                            @enderror
                                        </div>
