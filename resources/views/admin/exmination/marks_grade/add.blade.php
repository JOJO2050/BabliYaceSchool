                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('admin/exmination/marks_grade') }}" class="btn btn-primary btn-round">Voir
                                Liste des
                                des mentions</a>
                        </div>
                    </div>
                    ...
                    <div class="card my-4 p-4">
                        <div class="card-header" style="font-size: 20px;"><b>Formulaire d'ajout des mentions</b>
                        </div>
                                ...
                                <form class="settings-form" method="POST" action="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <label for="setting-input-1" class="form-label"><b>Mention</b></label>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="setting-input-1" class="form-label"><b>Note de debut</b></label>
                                            <input type="number" class="form-control" id="setting-input-1"
                                                name="percent_from" value="{{ old('percent_from') }}" placeholder="">
                                            @error('percent_from')
                                                <div class="text-danger"><b>{{ $message }}</b></div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="setting-input-1" class="form-label"><b>Note de fin</b></label>
                                            <input type="number" class="form-control" id="setting-input-1"
                                                name="percent_to" value="{{ old('percent_to') }}" placeholder="">
                                            @error('percent_to')
                                                <div class="text-danger"><b>{{ $message }}</b></div>
                                            @enderror
                                        </div>
