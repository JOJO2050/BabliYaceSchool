                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('admin/assign_class_teacher/add') }}"
                                class="btn btn-primary btn-round">Ajouter
                                une liaison classe & professeur</a>
                        </div>
                    </div>
                    @include('_message')
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="setting-input-1"
                                                ...
                                                placeholder="Entrez votre Nom de la classe ">
                                        </div>

                                        <div class="col-md-2 mb-3">
                                            <label for="setting-input-1" class="form-label"><b>Nom du
                                                    professeur</b></label>
                                            <input type="text" class="form-control" id="setting-input-1"
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-1" class="form-label"><b>Prénom du
                                                    professeur</b></label>
                                            <input type="text" class="form-control" id="setting-input-1"
                                            ...
                                            <tbody>
                                                @foreach ($getRecord as $value)
                                                    <tr>
                                                        ...
                                                        <td>{{ $value->teacher_name }} {{ $value->teacher_last_name }}
                                                        </td>
                                                        <td>
                                                            @if ($value->status == 0)
                                                                Active
