                            ...
                            <div class="card-body">
                                <form class="settings-form" method="POST" action="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label"><b>Nom des Professeurs</b></label>
    ...
    <script>
        function updateTeacherCount() {
            ...
            if (checked > 0) {
                ...
                button.innerText = "~~~~~~~~~~~~~~~~~~~~~~~Sélectionner professeur~~~~~~~~~~~~~~~~~~";
            }
        }
        ...
        // Mise à jour automatique au chargement (important pour l'édition)
