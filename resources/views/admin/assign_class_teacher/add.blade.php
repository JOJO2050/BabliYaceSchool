                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('admin/assign_class_teacher/list') }}"
                                class="btn btn-primary btn-round">Voir
                                la Liste des liaision classes & professeur</a>
                        </div>
                    </div>
                    @include('_message')
                    <div class="card my-4 p-4">
                        <div class="card-header" style="font-size: 20px;"><b>Formulaire d'ajout des liaisions classes &
                                professeur</b>
                        </div>
                                ...
                                <form class="settings-form" method="POST" action="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label"><b>Professeur</b></label>
                                                    ...
                                                    @foreach ($getTeacher as $teacher)
                                                        <li>
                                                            <label class="dropdown-item">
                                                                <input type="checkbox" name="teacher_id[]"
                                                                    value="{{ $teacher->id }}"
                                                                    class="form-check-input me-2 teacher-checkbox">
    ...
    <script>
        document.querySelectorAll('.teacher-checkbox').forEach(checkbox => {
            checkbox.addEventListener('change', function() {
                let checked = document.querySelectorAll('.teacher-checkbox:checked').length;
                let button = document.getElementById('dropdownMenuButton');

                if (checked > 0) {
                    button.innerText = checked + " professeur(s) sélectionnée(s)";
                } else {
                    button.innerText = "Sélectionner les professeurs";
                }
            });
        });
    </script>
