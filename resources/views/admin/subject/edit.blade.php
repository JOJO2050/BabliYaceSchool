            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="card my-4 p-4">
                        <div class="card-header" style="font-size: 20px;"><b>Formulaire d'édition des matières</b>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="type" required class="form-control">
                                                ...
                                                <option {{ $getRecord->type == 'Théorique' ? 'selected' : '' }}
                                                    value="Théorique">Théorique</option>
                                                <option {{ $getRecord->type == 'Pratique' ? 'selected' : '' }}
                                                    value="Pratique">
                                                    Pratique</option>
                                            </select>
                                        </div>
