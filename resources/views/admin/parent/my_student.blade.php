                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('admin/parent/list') }}" class="btn btn-primary btn-round">Liste
                                des Parents</a>
                        </div>
                    </div>
                    @include('_message')
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 mb-3">
                                                <label class="form-label"><b>ID de l'élève</b></label>
                                                <input type="text" name="id" value="{{ Request::get('id') }}"
                                                    class="form-control" placeholder="ID de l'élève">
                                            </div>
