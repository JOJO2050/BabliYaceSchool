...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="card my-4 p-4">
                        <div class="card-header" style="font-size: 20px;"><b>Formulaire d'edition des liaisions classes
                                &
                                matières</b>
                        </div>
                                ...
                                <form class="settings-form" method="POST" action="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Nom de la
                                                    Classe</b></label>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label"><b>Nom de la Matière</b></label>
                                                        ...
                                                        <li>
                                                            <label class="dropdown-item">
                                                                <input {{ $checked }} type="checkbox"
                                                                    ...
                                                                    class="form-check-input me-2 subject-checkbox">
                                                                {{ $subject->name }}
                                                            </label>
                                                        </li>
                                                    @endforeach
    ...
    <script>
        function updateSubjectCount() {
            let checked = document.querySelectorAll('.subject-checkbox:checked').length;
            let button = document.getElementById('dropdownMenuButton');

            if (checked > 0) {

                button.innerText = " ~~~~~~~~~~~~~~~~~~ " + checked + " matière(s) sélectionnée(s) ~~~~~~~~~~~~~~~~~~";
            } else {
                button.innerText = "Sélectionner Matière";
            }
        }
