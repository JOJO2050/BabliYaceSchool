                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('admin/assign_subject/add') }}" class="btn btn-primary btn-round">Ajouter
                                une liaison classe & matières</a>
                        </div>
                    </div>
                    @include('_message')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="setting-input-1"
                                                ...
                                                placeholder="Entrez votre Nom de la matière ">
                                        </div>
                    ...
                    <div class="card my-4 p-4">
                        <div class="card-header d-flex justify-content-between align-items-center"
                            ...
                            <b>Liste des liaision classes & matières</b>
