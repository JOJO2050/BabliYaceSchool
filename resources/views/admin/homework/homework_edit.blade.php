                ...
                <div class="page-inner">
                    ...
                    <div class="card my-4 p-4">
                        ...
                        <div class="card-header" style="font-size:20px;">
                            <b>Formulaire d'ediion de devoir</b>
                        </div>
                        ...
                        <div class="app-card app-card-settings shadow-sm p-4">
                            ...
                            <div class="card-body">
                                ...
                                <form class="settings-form" method="POST"
                                    action="{{ url('admin/homework/homework_update/' . $getRecord->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 mb-4">
                                            <label><b>Date d'emission du devoir</label><span
                                                style="color: red">*</span></b>
                                            <input type="date" value="{{ $getRecord->homework_date }}"
                                                class="form-control" name="homework_date">
                                            @error('homework_date')
                                        ...
                                        <div class="col-md-3 mb-4">
                                            <label><b>Date de rendu du devoir</label><span
                                                style="color: red">*</span></b>
                                            <input type="date" value="{{ $getRecord->submission_date }}"
                                                class="form-control" name="submission_date">
                                        ...
                                        <div class="col-md-3 mb-4">
                                            <label><b>Fichier pdf du devoir<span style="color: red">*</span></b></label>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="description" id="compose-textarea" class="form-control" rows="15">{{ $getRecord->description }}</textarea>
                                        @error('description')
