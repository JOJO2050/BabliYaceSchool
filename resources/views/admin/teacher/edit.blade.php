            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="card my-4 p-4">
                        <div class="card-header" style="font-size: 20px;"><b>Formulaire d'édition des professeurs</b>
                        </div>
                            ...
                            <div class="card-body">
                                <form class="settings-form" method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Status Matrimonial
                                                </b></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Addresse Permanent
                                                </b></label>
                                            <textarea class="form-control" name="permanent_address" placeholder="Entrez l'Addresse permanent">{{ old('permanent_address', $getRecord->permanent_address) }}</textarea>
                                            @error('permanent_address')
                                                <div class="text-danger"><b>{{ $msessage }}</b></div>
                                            @enderror
                                        </div>

                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Qualification
                                                </b></label>
                                            <textarea class="form-control" name="qualification" placeholder="Entrez la qualification">{{ old('qualification', $getRecord->qualification) }}</textarea>
                                            @error('qualification')
                                                <div class="text-danger"><b>{{ $msessage }}</b></div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Experience
                                                    professionnelle
                                                </b></label>
                                            <textarea class="form-control" name="work_experience" placeholder="Entrez l'Experience professionnelle">{{ old('work_experience', $getRecord->work_experience) }}</textarea>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <textarea class="form-control" name="note" placeholder="Entrez la note">{{ old('note', $getRecord->note) }}</textarea>
                                            @error('note')
                                                <div class="text-danger"><b>{{ $msessage }}</b></div>
                                            @enderror
                                        </div>
