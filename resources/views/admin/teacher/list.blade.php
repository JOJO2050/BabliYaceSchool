                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('admin/teacher/add') }}" class="btn btn-primary btn-round">Ajouter
                                un professeur</a>
                        </div>
                    </div>
                    @include('_message')
                                ...
                                <form class="settings-form" method="GET" action="">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <label class="form-label"><b>Statu matrimonial</b></label>
                    ...
                    <div class="card my-4 p-4">
                        <div class="card-header d-flex justify-content-between align-items-center"
                            ...
                            <span class="app-page-title px-3 py-1 rounded"
                                ...
                                <b> Total professeur : {{ $getRecord->total() }}</b>
                            </span>
                                            ...
                                            <table class="table table-striped mt-3">
                                                <thead class="table-success">
                                                    <tr>
                                                        ...
                                                        <th>Contact</th>
                                                        <th>Status Matrmonial</th>
                                                        <th>Address Postale</th>
                                                        <th>Address Permanant</th>
                                                        <th>Qualification</th>
