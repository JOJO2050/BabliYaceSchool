                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('admin/teacher/list') }}" class="btn btn-primary btn-round">Voir Liste des
                                professeurs</a>
                        </div>
                    </div>
                    @include('_message')
                    <div class="card my-4 p-4">
                        <div class="card-header" style="font-size: 20px;"><b>Formulaire d'ajout des professeurs</b>
                        </div>
                            ...
                            <div class="card-body">
                                <form class="settings-form" method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="setting-input-1"
                                                name="name" value="{{ old('name') }}" placeholder="Entrez le Nom">
                                            @error('name')
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select name="gender" class="form-control">
                                                ...
                                                <option {{ old('gender') == 'Male' ? 'selected' : '' }} value="Male">
                                                    Male</option>
                                                <option {{ old('gender') == 'Femelle' ? 'selected' : '' }}
                                                    value="Femelle">Femelle</option>
                                                <option {{ old('gender') == 'Autre' ? 'selected' : '' }}
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-1" class="form-label"><b>Date de naissance</b>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-1" class="form-label"><b>Date d'Adhesion</b>
                                                <span style="color: red"><b>*</b></span></label>
                                            <input type="date" class="form-control" id="setting-input-1"
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Addresse
                                                    Postale</b></label>
                                            <textarea class="form-control" id="setting-input-3" name="address" value="{{ old('address') }}"
                                                placeholder="Entrez l'addresse postale"></textarea>
                                            @error('address')
                                                <div class="text-danger"><b>{{ $message }}</b></div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Addresse
                                                    Permanant</b></label>
                                            <textarea class="form-control" id="setting-input-3" name="permanent_address" value="{{ old('permanent_address') }}"
                                                placeholder="Entrez l'addresse permanant"></textarea>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>
                                                    Qualification</b></label>
                                            <textarea class="form-control" id="setting-input-3" name="qualification" value="{{ old('qualification') }}"
                                                placeholder="Entrez la qualification"></textarea>
                                            @error('qualification')
                                                <div class="text-danger"><b>{{ $message }}</b></div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>
                                                    Experience Professionnelle</b></label>
                                            <textarea class="form-control" id="setting-input-3" name="work_experience" value="{{ old('work_experience') }}"
                                                placeholder="Entrez l'experience professionnelle"></textarea>
                                            @error('address')
                                                <div class="text-danger"><b>{{ $message }}</b></div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>
                                                    Note</b></label>
                                            <textarea class="form-control" id="setting-input-3" name="note" value="{{ old('note') }}"
                                                placeholder="Entrez une note"></textarea>
                                            @error('note')
                                                <div class="text-danger"><b>{{ $message }}</b></div>
                                            @enderror
                                        </div>
