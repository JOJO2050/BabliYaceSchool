            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="card my-4 p-2">
                        <div class="card-header" style="font-size:20px;"><b>Espace de recherche...</b></div>
                                ...
                                <form class="settings-form" method="GET"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            <label class="form-label"><b>Classe</b></label>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label"><b>Matière</b></label>
                                            <select name="subject_id" class="form-control" id="getSubject">
                                                <option value="">~ Sélectionnez une classe pour avoir accès aux
                                                    matières ~</option>
                                                @if (!empty($getSubject))
                                        ...
                                        <div class="col-md-2 mb-3">
                                            <label class="form-label"><b>Matricule de l'élève</b></label>
                                        ...
                                        <div class="col-md-2 mb-3">
                                            <label class="form-label"><b>Type de pointage</b></label>
                                            <select name="attendance_type" class="form-control">
                                                <option value="">~~~ Choisir le type de pointage ~~~</option>
                                                <option value="1"
                                                    {{ Request::get('attendance_type') == 1 ? 'selected' : '' }}>
                                                    Présent</option>
                                                <option value="2"
                                                    {{ Request::get('attendance_type') == 2 ? 'selected' : '' }}>Absent
                                                </option>
                                            </select>
                                        </div>

                                        <div class="col-md-2 mb-3">
                                            <label class="form-label"><b>Date de pointage</b></label>
                                        ...
                                        <div class="col-md-1 mb-3">
                                            ...
                                            <a href="{{ url('admin/attendance/report') }}" class="btn btn-danger"
                                                style="margin-top:30px" title="Effacer les filtres"><i
                    ...
                    <div class="app-card app-card-settings shadow-sm p-4">
                        <div class="card-body">
                            <div class="card-header d-flex justify-content-between align-items-center"
                                style="font-size:20px;"><b>Liste de pointage de présence</b></div>
                                ...
                                <table class="table table-striped mt-3">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Matière de l'élève</th>
                                            <th>Pointage de l'élève</th>
                                    ...
                                    <tbody>
                                        @forelse ($getRecord as $value)
                                            <tr>
                                                ...
                                                <td><b>Le</b> {{ date('d-m-Y', strtotime($value->attendance_date)) }}
                                                </td>
                                                <td>{{ $value->created_name }}</td>
                                                <td>Le {{ date('d-m-Y', strtotime($value->created_at)) }} à
                                                ...
                                                <td colspan="8" class="text-center">
                                                    <div class="alert alert-info mb-0">
                                                        @if (Request::filled('class_id'))
                                                            Aucun pointage trouvé pour cette classe.
                                                        @else
                                                            Sélectionnez une classe puis cliquez sur rechercher.
                                                        @endif
                                                    </div>
                                                </td>
                                            </tr>
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function(key, value) {
                            $('#getSubject').append('<option value="' + value.subject_id +
