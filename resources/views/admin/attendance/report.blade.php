                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select name="subject_id" class="form-control" id="getSubject">
                                                ...
                                                <option value="">
                                                    ~Selectionnez une classe pour avoir accès aux matières
                                                    ~
                                                </option>
                                        ...
                                        <div class="col-md-2 mb-3">
                                            <label class="form-label">
                                                <b>Matricule de lélève</b> <span style="color:red">*</span>
                                            </label>
                                        ...
                                        <div class="col-md-2 mb-3">
                                            <label class="form-label">
                                                <b>Type de pointage</b> <span style="color:red">*</span>
                                            </label>
                            ...
                            <tbody>
                                @foreach ($getRecord as $value)
                                    <tr>
                                        ...
                                        <td>
                                            Le {{ date('d-m-Y', strtotime($value->created_at)) }}
                                            à {{ date('H:i', strtotime($value->created_at)) }}
                                        </td>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        $('#getSubject').html(
                            '<option value="">~~~~~~~~~~~Auncune matière pour cette classse ~~~~~~~~~~~</option>'
                        );
