                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('admin/student/list') }}" class="btn btn-primary btn-round">Voir Liste des
                                Elèves</a>
                        </div>
                    </div>
                    @include('_message')
                    <div class="card my-4 p-4">
                        <div class="card-header" style="font-size: 20px;"><b>Formulaire d'édition des élèves</b>
                        </div>
                            ...
                            <div class="card-body">
                                <form class="settings-form" method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-1" class="form-label"><b>Numero d'admission</b>
                                                <span style="color: red"><b>*</b></span></label>
                                            <input type="text" class="form-control" id="setting-input-1"
                                                name="admission_number"
                                                value="{{ old('admission_number', $getRecord->admission_number) }}"
                                                placeholder="Entrez le Numero d'admission">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-1" class="form-label"><b>Numero maricule</b>
                                                <span style="color: red"><b>*</b></span></label>
                                            <input type="text" class="form-control" id="setting-input-1"
                                                name="roll_number"
                                                value="{{ old('roll_number', $getRecord->roll_number) }}"
                                                placeholder="Entrez le Numero maricule">
                                            @error('roll_number')
                                                <div class="text-danger"><b>{{ $message }}</b></div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Classe</b> <span
                                                    style="color: red"><b>*</b></span></label>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Caste</b></label>
                                            <input type="text" class="form-control" id="setting-input-3"
                                                name="caste" value="{{ old('caste', $getRecord->caste) }}"
                                                placeholder="Entrez le caste">
                                            @error('caste')
                                                <div class="text-danger"><b>{{ $message }}</b></div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Religion</b></label>
                                            <input type="text" class="form-control" id="setting-input-3"
                                                name="religion" value="{{ old('religion', $getRecord->religion) }}"
                                                placeholder="Entrez la religion">
                                            @error('religion')
                                                <div class="text-danger"><b>{{ $message }}</b></div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Date d'Admission
                                                </b> <span style="color: red"><b>*</b></span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Groupe
                                                    Sanguin</b></label>
                                            <input type="text" class="form-control" id="setting-input-3"
                                                name="blood_group"
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Taille
                                                </b></label>
                                            <input type="text" class="form-control" id="setting-input-3"
                                                name="heigth" value="{{ old('heigth', $getRecord->heigth) }}"
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label for="setting-input-3" class="form-label"><b>Poids
                                                </b></label>
                                            <input type="text" class="form-control" id="setting-input-3"
                                                name="weigth" value="{{ old('weigth', $getRecord->weigth) }}"
