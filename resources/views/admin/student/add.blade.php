            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="card my-4 p-4">
                        <div class="card-header" style="font-size: 20px;"><b>Formulaire d'ajout des élèves</b>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select name="class_id" id="class_select" class="form-control"
                                                ...
                                                <option value="">~~~~~~~~~~Veillez choisir une classe~~~~~~~~~~~
                                                </option>
