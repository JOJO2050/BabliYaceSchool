                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('admin/student/add') }}" class="btn btn-primary btn-round">Ajouter
                                un élève</a>
                        </div>
                    </div>
                    @include('_message')
                            ...
                            <div class="card-body">
                                <form class="settings-form" method="GET" action="">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-3">
                                                <label class="form-label"><b>N° Matricule</b></label>
                                                <input type="text" name="roll_number"
                                                    value="{{ Request::get('roll_number') }}" class="form-control"
                                                    placeholder="Entrer N° Matricule">
                                            </div>

                                            <div class="col-md-3 mb-3">
                                                <label class="form-label"><b>Entrez le nom de la classe</b></label>
                                                <input type="text" name="class"
                                                    value="{{ Request::get('class') }}" class="form-control"
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select name="gender" class="form-control">
                                                    ...
                                                    <option
                                                        ...
                                                        Male</option>
                                                    <option
                                                        {{ Request::get('gender') == 'Female' ? 'selected' : '' }}value="Female">
                                                        Female</option>
                                                    <option
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <label class="form-label"><b>Date naissance</b></label>
                                                <input type="date" name="date_of_birth"
                                                    value="{{ Request::get('date_of_birth') }}" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" name="caste"
                                                    ...
                                                    placeholder="Entrer le Caste">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label class="form-label"><b>Religion</b></label>
                                                <input type="text" name="religion"
                                                    value="{{ Request::get('religion') }}" class="form-control"
                                                    placeholder="Entrer la Religion">
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <label class="form-label"><b>Taille</b></label>
                                                <input type="text" name="heigth"
                                                    value="{{ Request::get('heigth') }}" class="form-control"
                                                    placeholder="Entrer la Taille">
                                            </div>

                                            <div class="col-md-3 mb-3">
                                                <label class="form-label"><b>Poids</b></label>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select name="status" class="form-control">
                                                    ...
                                                    <option
                                                        ...
                                                        Active</option>
                                                    <option
                                                        {{ Request::get('status') == '1' ? 'selected' : '' }}value="1">
                                                        Inactive</option>
