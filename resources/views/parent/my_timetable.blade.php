                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            ...
                            <a href="{{ url('parent/my_student') }}" class="btn btn-primary btn-round">Voir mes enfants
                    ...
                    <div class="card my-4 p-4">
                        <div class="card-header d-flex justify-content-between align-items-center"
                            ...
                            <b>
                                Emploi de temps de ➡️:
                                <span style="color: rgb(233, 139, 139);">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <span class="px-3 py-1 rounded"
                                        style="background-color:#28a745; font-size:14px; display:inline-block; width:auto;">

                                        <b>
                                            <span style="color:white;">{{ $getSubject->name }}</span>
                                            ➡️
                                            <span style="color:rgb(255, 255, 255);">{{ $getClass->name }}</span>
                                        </b>
