                ...
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            <a href="{{ url('parent/my_student') }}" class="btn btn-primary btn-round">
                    ...
                    <div class="card my-4 p-2">
                        ...
                        <div class="card my-4 p-2">
                            <div class="app-card app-card-settings shadow-sm p-4" style="background-color:#d8e0de;">
                                <div class="card-body">
                                    <form method="GET"
                                        action="{{ url('parent/my_student/homework_submitted/' . $getStudent->id) }}">
                                        ...
                                        <div class="row g-3 align-items-end">
                                            ...
                                            <div class="col-md-3">
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <a href="{{ url('parent/my_student/homework_submitted/' . $getStudent->id) }}"
                                            ...
                                            @forelse ($getRecord as $value)
                                                <tr>
                                                    ...
                                                    <td class="text-center"
                                                        style="background:#eff6ff; white-space:nowrap;">
                                                        @if (!empty($value->getHomework->getDocument()))
                                                            <a href="{{ $value->getHomework->getDocument() }}"
                                                                class="btn btn-primary btn-sm btn-download" download>
                                                    ...
                                                    <td class="text-center"
                                                        style="background:#f0fdf4; white-space:nowrap;">
                                                        @if (!empty($value->getDocument()))
                                                            <a href="{{ $value->getDocument() }}"
                                                                class="btn btn-success btn-sm btn-download" download>
                                                                <i class="fas fa-file-pdf"></i>
                                                                <span>Télécharger</span>
                                                            </a>
                                                        @else
