                      ...
                      <li>
                          <div class="message-notif-scroll scrollbar-outer">
                              <div class="notif-center">
                                  <a href="#">
                                      <div class="notif-img">
                                          <img src=" {{ asset('assets1/img/jm_denis.jpg') }}" alt="Img Profile" />
                                      </div>
                                  ...
                                  <a href="#">
                                      <div class="notif-img">
                                          <img src=" {{ asset('assets1/img/chadengle.jpg') }}" alt="Img Profile" />
                                      </div>
                                      <div class="notif-content">
                                  ...
                                  <a href="#">
                                      <div class="notif-img">
                                          <img src=" {{ asset('assets1/img/mlane.jpg') }}" alt="Img Profile" />
                                      </div>
                                      <div class="notif-content">
                              ...
                              <div class="user-box">
                                  ...
                                  <div class="u-text">
                                      ...
                                      <a href="{{ url('profile/profil_detail') }}"
                                          class="btn btn-xs btn-secondary btn-sm">Voir mon
                                          Profil</a>
                                  </div>
                              </div>
                          </li>
