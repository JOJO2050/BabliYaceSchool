...
class ClassTeacherModel extends Model
{
    ...
    {
        return  ClassTeacherModel::select("assign_class_teacher.*", "class.name as class_name", "subject.name as subject_name", "subject.type as subject_type", "class.id as class_id", "subject.id as subject_id")
            ->join("class", "class.id", "=", "assign_class_teacher.class_id")
