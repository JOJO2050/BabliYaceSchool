...
class User extends Authenticatable
{
    ...
    static public function getAdmin()     // permet juste de retourner tous les utilisateur qui sont des admin et de type_user =1
    {
    ...
    static public function getTeacher()     // permet de gerer le TEACHER
    {
        ...
        if (!empty(Request::get("admission_date"))) {
            $return = $return->whereDate("users.admission_date", "=", Request::get("date"));
        }
    ...
    static public function getTeacherClass()     // permet de gerer les CLASSE & TEACHER
    {
        $return = self::select("users.*")
            ->where("users.user_type", "=", 2)
            ->where("users.is_delete", "=", 0);
    ...
    static public function getStudent()     // permet de gerer le STUDENT
    {
        ...
        if (!empty(Request::get("date_of_birth"))) {
            $return = $return->whereDate("users.date_of_birth", "=", Request::get("date"));
        }
    ...
    static public function getParent()    // permet de gerer le PARENT
    {
        $return = self::select("users.*")
            ->where("user_type", "=", 4)
            ->where("is_delete", "=", 0);
